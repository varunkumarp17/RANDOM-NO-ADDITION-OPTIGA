...
int main(void)
{
    ...
    const char *pers = "personalized_data";
    ...
    uint8_t sum_array[ARRAY_SIZE];
    size_t len = ARRAY_SIZE;
    if (mbedtls_ctr_drbg_random(&ctr_drbg, array1, len) != 0)
       {
           printf("\r\nRandom Array 1 generation failed!\r\n");
       }
       else
       {
           printf("\r\nRandom Array 1:\r\n");
           print_uint8_data(array1, len);
       }

    if (mbedtls_ctr_drbg_random(&ctr_drbg, array2, len) != 0)
        {
            printf("\r\nRandom Array 2 generation failed!\r\n");
        }
        else
        {
            printf("\r\nRandom Array 2:\r\n");
            print_uint8_data(array2, len);
        }
        ...
        print_uint8_data(sum_array, len);
